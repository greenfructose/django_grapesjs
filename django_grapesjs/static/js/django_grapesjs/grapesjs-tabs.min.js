/*! grapesjs-tabs - 1.0.7 */ ! function(t, e) {
    ...
    return function(t) {
        ...
        var b = function(t, e) {
            var n = e.defaultModel,
                ...
                p = function(t) {
                    return t.getAttributes()["data-prev"]
                };
            t.addType(i.typeTab, {
                model: {
                    defaults: s({
                        ...
                        if (!this.tabContent) {
                            ...
                            if (t && p(t)) {
                                ...
                                t.addAttributes({
                                    ...
                                    'aria-labelledby': r,
                                    hidden: !0
                                }), t.removeAttributes("data-prev"), this.addAttributes((e = {}, o()(e, a, n), o()(e, "id", r), e))
                            }
                            if (!t) {
                                var c, s = (t = this.getTabsType().getContentsType().append({
                                ...
                                t.addAttributes({
                                    ...
                                    'aria-labelledby': b,
                                    hidden: !0
                                }), this.addAttributes((c = {}, o()(c, a, s), o()(c, "id", b), c)), this.tabContent = t
                            }
                            this.tabContent = t
                        }
                    },
                    ...
                    clone: function() {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                            e = t._inner;
                        if (e) {
                            var r = this.getTabContent();
                            r && r.addAttributes(o()({}, "data-prev", r.getId()))
                        }
                        var c = n.prototype.clone.apply(this, arguments);
                        return !e && c.addAttributes(o()({}, a, '')), c
                    }
                }
            })
        };
                    ...
                    defaults: l({
                        ...
                        script: function(t) {
                            var e, n, r = this,
                                ...
                                h = function(t) {
                                    y(g(), (function(t) {
                                        t.className = t.className.replace(o, '').trim(), t.ariaSelected = 'false', v(t, '-1')
                                    })), y(r.querySelectorAll("[role=tabpanel]"), (function(t) {
                                        return t.hidden = !0
                                    })), t.className += ' ' + o, t.ariaSelected = 'true', v(t, '0');
                                    var e = d(t),
                                        n = e && O(r, "#".concat(e));
                                    n && (n.hidden = !1)
                                },
                                j = O(r, ".".concat(o).concat(b));
                            (j = j || (n = (u.hash || '').replace('#', '')) && O(r, (e = a, "".concat(b, "[").concat(e, "=").concat(n, "]"))) || O(r, b)) && h(j), r.addEventListener('click', (function(t) {
                                var e = t.target,
                                    n = f.call(e, b);
                                if (n || (e = function(t) {
                                        var e;
