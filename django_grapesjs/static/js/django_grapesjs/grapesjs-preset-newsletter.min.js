...
! function(t, e) {
    ...
    return function(t) {
        ...
        function c(t, e) {
            return (C(t) ? r : O)(t, "function" == typeof e ? e : b)
        }
        ...
        (function(e) {
            ...
            function _(t, e, r, n, i, o, a, s, c, l) {
                function h() {
                    ...
                    var B = v ? r : this,
                        D = y ? B[t] : t;
                    return k = E.length, s ? E = L(E, s) : w && k > 1 && E.reverse(), p && c < k && (E.length = c), this && this !== _t && this instanceof h && (D = S || b(D)), D.apply(B, E)
                }
                var p = e & X,
                    v = e & $,
                    y = e & H,
            ...
            function N(t) {
                ...
                t = t.replace(ut, "");
                var r = pt.test(t);
                return r || gt.test(t) ? yt(t.slice(2), r ? 2 : 8) : ht.test(t) ? rt : +t
            }
        ...
        a.prototype._stateText = function(t) {
            ...
            n(t) || (">" === t ? this._state = h : this._special !== dt ? "s" === t || "S" === t ? this._state = V : (this._state = h, this._index--) : (this._state = y, this._sectionStart = this._index))
        }, a.prototype._stateInCloseingTagName = function(t) {
            (">" === t || n(t)) && (this._emitToken("onclosetag"), this._state = b, this._index--)
            ...
            ">" === t || n(t) ? (this._special = dt, this._state = y, this._sectionStart = this._index - 6, this._index--) : this._state = h
            ...
            ">" === t || n(t) ? (this._special = dt, this._state = y, this._sectionStart = this._index - 5, this._index--) : this._state = h
        ...
        (function(e, n) {
            ...
            function c(t, e, r, n, o) {
                ...
                if (null === e) a.reading = !1, g(t, a);
                    ...
                    var s;
                    o || (s = f(a, e)), s ? t.emit("error", s) : a.objectMode || e && e.length > 0 ? ("string" == typeof e || a.objectMode || Object.getPrototypeOf(e) === R.prototype || (e = i(e)), n ? a.endEmitted ? t.emit("error", new Error("stream.unshift() after end event")) : l(t, a, e, !0) : a.ended ? t.emit("error", new Error("stream.push() after EOF")) : (a.reading = !1, a.decoder && !r ? (e = a.decoder.write(e), a.objectMode || 0 !== e.length ? l(t, a, e, !1) : b(t, a)) : l(t, a, e, !1))) : n || (a.reading = !1)
                }
                return h(a)
            }

            function l(t, e, r, n) {
                e.flowing && 0 === e.length && !e.sync ? (t.emit("data", r), t.read(0)) : (e.length += e.objectMode ? 1 : r.length, n ? e.buffer.unshift(r) : e.buffer.push(r), e.needReadable && v(t)), b(t, e)
            }
            ...
            function v(t) {
                ...
                e.needReadable = !1, e.emittedReadable || (F("emitReadable", e.flowing), e.emittedReadable = !0, e.sync ? B.nextTick(y, t) : y(t))
            }
            ...
            u.prototype.read = function(t) {
                ...
                function o() {
                    F("cleanup"), t.removeListener("close", c), t.removeListener("finish", l), t.removeListener("drain", v), t.removeListener("error", u), t.removeListener("unpipe", r), h.removeListener("end", i), h.removeListener("end", f), h.removeListener("data", s), y = !0, !p.awaitDrain || t._writableState && !t._writableState.needDrain || v()
                }

                function s(e) {
                    F("ondata"), b = !1, !1 !== t.write(e) || b || ((1 === p.pipesCount && p.pipes === t || p.pipesCount > 1 && -1 !== C(p.pipes, t)) && !y && (F("false write response, pause", h._readableState.awaitDrain), h._readableState.awaitDrain++, b = !0), h.pause())
                }
        ...
        function g(t) {
            return y(t) && O.call(t, "callee") && (!C.call(t, "callee") || L.call(t) == j)
        }
        ...
        o.compile = p, o.filters = a.filters, o.pseudos = a.pseudos, o.selectAll = v, o.selectOne = y, o.is = i, o.parse = p, o.iterate = v, o._compileUnsafe = d, o._compileToken = g
    }, function(t, e, r) {
        var n = r(4),
            i = n.hasAttrib,
        ...
        function n(t) {
            ...
            function l(e) {
                if (1 == (e || 1)) "\n" == t[y] ? (m++, v = 1) : v++, y++;
                    ...
                    var r = t.slice(y, y + e).split("\n");
                    r.length > 1 && (m += r.length - 1, v = 1), v += r[r.length - 1].length, y += e
                }
            }
            ...
            for (o && (p = Date.now()); d = function() {
                ...
                case "{":
                    switch (e()) {
                        case "selector":
                            ...
                            x.text = g.trim(), f(), c("before-name"), b += 1;
                            break;
                        case "at-group":
                        ...
                        case "name":
                        case "at-rule":
                            x.name = g.trim(), f(), u("before-name"), b += 1;
                            break;
                        case "comment":
                        case "double-string":
                        case "single-string":
                ...
                case "}":
                    switch (e()) {
                        ...
                        case "before-value":
                        case "value":
                            g && (x.value = g.trim()), x.name && x.value && f(), h("end"), f(), s(), "at-group" === e() && (h("at-group-end"), f(), s()), b > 0 && (b -= 1);
                            break;
                        case "at-group":
                        case "before-selector":
                        case "selector":
                            ...
                            b > 0 && "at-group" === e(1) && (h("at-group-end"), f()), b > 1 && s(), b > 0 && (b -= 1);
                            break;
                        case "double-string":
                        case "single-string":
                        case "comment":
        ...
        e.default = i.default.plugins.add("gjs-preset-newsletter", function(t, e) {
            ...
            r(48)(n), r(115)(n), r(116)(n), r(117)(n), t.on("change:selectedComponent", function() {
        ...
        function s(t, e, r) {
            ...
            for (a(0);
                "" !== e;)
                if (b = e.charAt(0), o(b)) x = !0, a(1);
                else if (b in p) w.push({
                type: p[b]
            }), x = !1, a(1);
            else if ("," === b) {
                ...
                t.push(w), w = [], x = !1, a(1)
                    ...
                    type: "descendant"
                }), x = !1), "*" === b) e = e.substr(1), w.push({
                type: "universal"
            });
            else if (b in d) e = e.substr(1), w.push({
                type: "attribute",
                name: d[b][0],
                action: d[b][1],
                value: n(),
                ...
                if (e = e.substr(1), m = n().toLowerCase(), l = null, "(" === e.charAt(0))
                    if (m in g) {
                        ...
                        l = e.substr(1, j - 2), e = e.substr(j), m in v && (_ = l.charAt(0), _ === l.slice(-1) && _ in y && (l = l.slice(1, -1)), l = i(l))
                    } w.push({
                    type: "pseudo",
                    name: m,
                    data: l
        ...
        (function(t, r) {
            ...
            function f(t) {
                var e = this.__data__;
                return ye ? void 0 !== e[t] : Zt.call(e, t)
            }

            function h(t, e) {
                var r = this.__data__;
                return this.size += this.has(t) ? 0 : 1, r[t] = ye && void 0 === e ? xt : e, this
            }
            ...
            function Z(t) {
                return "function" != typeof t.constructor || nt(t) ? {} : be(se(t))
            }
            ...
            s.prototype.clear = u, s.prototype.delete = c, s.prototype.get = l, s.prototype.has = f, s.prototype.set = h, p.prototype.clear = d, p.prototype.delete = g, p.prototype.get = v, p.prototype.has = y, p.prototype.set = b, m.prototype.clear = _, m.prototype.delete = w, m.prototype.get = x, m.prototype.has = S, m.prototype.set = j, k.prototype.clear = E, k.prototype.delete = A, k.prototype.get = T, k.prototype.has = O, k.prototype.set = L;
            var me = function(t) {
                    return function(e, r, n) {
                        for (var i = -1, o = Object(e), a = n(e), s = a.length; s--;) {
                            var u = a[t ? s : ++i];
        ...
        (function(t, r) {
            ...
            function U(t, e) {
                e = ft(e, t) ? [e] : et(e);
                for (var r = 0, n = e.length; null != t && r < n;) t = t[yt(e[r++])];
            ...
            function W(t) {
                return !(!At(t) || pt(t)) && (kt(t) || s(t) ? Ce : fe).test(bt(t))
            }
            ...
            function X(t, e) {
                return ft(t) && gt(e) ? vt(yt(t), e) : function(r) {
                    var n = Ct(r, t);
            ...
            var de = "object" == typeof t && t && t.Object === Object && t,
                ...
                be = ye && "object" == typeof r && r && !r.nodeType && r,
                me = be && be.exports === ye,
                _e = me && de.process,
                we = function() {
                    try {
            ...
            l.prototype.clear = f, l.prototype.delete = h, l.prototype.get = p, l.prototype.has = d, l.prototype.set = g, v.prototype.clear = y, v.prototype.delete = b, v.prototype.get = m, v.prototype.has = _, v.prototype.set = w, x.prototype.clear = S, x.prototype.delete = j, x.prototype.get = k, x.prototype.has = E, x.prototype.set = A, T.prototype.add = T.prototype.push = O, T.prototype.has = L, C.prototype.clear = B, C.prototype.delete = D, C.prototype.get = q, C.prototype.has = P, C.prototype.set = M;
            var Xe = function(t, e) {
                    return function(r, n) {
                        if (null == r) return r;
        ...
        (function(t, r) {
            ...
            function Y(t) {
                return !(!Tt(t) || pt(t)) && (Et(t) || u(t) ? Be : he).test(bt(t))
            }
            ...
            var ge = "object" == typeof t && t && t.Object === Object && t,
                ...
                me = be && "object" == typeof r && r && !r.nodeType && r,
                _e = me && me.exports === be,
                we = _e && ge.process,
                xe = function() {
                    try {
            ...
            f.prototype.clear = h, f.prototype.delete = p, f.prototype.get = d, f.prototype.has = g, f.prototype.set = v, y.prototype.clear = b, y.prototype.delete = m, y.prototype.get = _, y.prototype.has = w, y.prototype.set = x, S.prototype.clear = j, S.prototype.delete = k, S.prototype.get = E, S.prototype.has = A, S.prototype.set = T, O.prototype.add = O.prototype.push = L, O.prototype.has = C, B.prototype.clear = D, B.prototype.delete = q, B.prototype.get = P, B.prototype.has = M, B.prototype.set = R;
            var Ze = function(t, e) {
                    return function(r, n) {
                        if (null == r) return r;
        ...
        (function(t, r) {
            ...
            function Y(t) {
                return !(!At(t) || pt(t)) && (kt(t) || u(t) ? Ce : fe).test(bt(t))
            }
        ...
        (function(t, r) {
            ...
            function Y(t) {
                return !(!At(t) || pt(t)) && (kt(t) || c(t) ? Ce : fe).test(bt(t))
            }
            ...
            var de = "object" == typeof t && t && t.Object === Object && t,
                ...
                Je = Ye ? Ye.valueOf : void 0,
                Qe = Ye ? Ye.toString : void 0;
            h.prototype.clear = p, h.prototype.delete = d, h.prototype.get = g, h.prototype.has = v, h.prototype.set = y, b.prototype.clear = m, b.prototype.delete = _, b.prototype.get = w, b.prototype.has = x, b.prototype.set = S, j.prototype.clear = k, j.prototype.delete = E, j.prototype.get = A, j.prototype.has = T, j.prototype.set = O, L.prototype.add = L.prototype.push = C, L.prototype.has = B, D.prototype.clear = q, D.prototype.delete = P, D.prototype.get = M, D.prototype.has = R, D.prototype.set = I;
            var Xe = function(t, e) {
                    return function(r, n) {
                        if (null == r) return r;
                        if (!St(r)) return t(r, n);
        ...
        t.exports = {
            _args: [
                ["cheerio@0.22.0", "/Users/arturarseniev/Sites/grapesjs-preset-newsletter"]
            ],
            ...
            _spec: "0.22.0",
            _where: "/Users/arturarseniev/Sites/grapesjs-preset-newsletter",
            author: {
                name: "Matt Mueller",
        ...
        function n(t, e) {
            ...
            var n, i, a = [];
            for (b && (r = Date.now()); i = o();)(n = p(i)) && a.push(n);
            return b && m("ran in", Date.now() - r + "ms"), {
                type: "stylesheet",
                stylesheet: {
                    rules: a
                }
        ...
        function i(t, e) {
            ...
            }), y && m("astNode:", JSON.stringify(i, null, 2)), i
        }

        function o() {
            var t = j.shift();
            return y && m("next:", JSON.stringify(t, null, 2)), t
        }
        ...
        function p(t) {
            ...
            y && m("parseToken: unexpected token:", JSON.stringify(t))
        }
        ...
        function n(t, e) {
            var r;
            e || (e = {}), y = e.indentation || "", v = !!e.compress, g = !!e.comments, v ? b = m = "" : (b = "\n", m = " "), w && (r = Date.now());
            var n = c(t.stylesheet.rules, p).join("\n").trim();
            return w && x("ran in", Date.now() - r + "ms"), n
        }

        function i(t) {
            return this.level || (this.level = 1), t ? void(this.level += t) : v ? "" : Array(this.level).join(y || "")
        }

        function o(t) {
            return "@" + t.type + " " + t.value + ";" + b
        }
        ...
        function u(t) {
            var e;
            return t.selectors ? e = t.selectors.join("," + b) : (e = "@" + t.type, e += t.name ? " " + t.name : ""), i() + e + m + l(t) + b
        }
        ...
        function l(t, e) {
            var r = t.declarations,
                n = h;
            return t.rules && (r = t.rules, n = u), r = f(r, n), r && (r = b + r + (e ? "" : b)), "{" + r + i() + "}"
        }
        ...
        var l = function(t, e, r, n, i, s, l, f, h, p, d, g, v, y, b, m) {
                var _, w;
                ...
                } else v ? (m = m || b, (w.pseudos || (w.pseudos = [])).push({
            ...
            function e(e, o, s) {
                function u(r) {
                    ...
                    if (f) {
                        var b = l[l.length - 1],
                            m = b.pseudos;
                        b.pseudos = a(b.pseudos), o = l.toString(), b.pseudos = m
                    }
                    var _;
                    try {
                        _ = e(o)
                ...
                if (s.styleAttributeName && (v = s.styleAttributeName), d.forEach(u), g.forEach(c), s.inlinePseudoElements && g.forEach(l), s.applyWidthAttributes && g.forEach(function(t) {
                    ...
                    var y = n.getPreservedText(s.extraCss, {
                        mediaQueries: s.preserveMediaQueries,
                        fontFaces: s.preserveFontFaces
                    });
                    if (y) {
                        var b = null;
                        !0 !== s.insertPreservedExtraCss ? b = e(s.insertPreservedExtraCss) : (b = e("head"), b.length || (b = e("body")), b.length || (b = e.root())), b.first().append("<style>" + y + "</style>")
                    }
                }
            }
